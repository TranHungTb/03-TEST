...
// Hầu hết các chân tín hiệu đều có thể định cấu hình được, nhưng chân CLK có một số
// các ràng buộc đặc biệt. Trên bo mạch 8 bit, nó phải ở trên PORTB ...
// Chân 8 hoạt động trên Arduino Uno & compatibles (ví dụ: Adaf nhung Metro),
// Chân 11 hoạt động trên Arduino Mega. Trên bảng SAMD 32 bit, nó phải là
// trên cùng PORT với các chân dữ liệu RGB (D2-D7) ...
// Pin 8 hoạt động trên Adaf nhung Metro M0 hoặc Arduino Zero,
// Pin A4 hoạt động trên Adaf nhung Metro M4 (nếu sử dụng Adaf nhung RGB
// Matrix Shield, cắt dấu vết giữa các miếng CLK và chạy dây sang A4).
